    ...
    zh: {
        ...
        info: {
            ...
            timelineItems: [
                ...
                },
                {
                    date: "6/22 - 7/4",
                    event: "初賽審評",
                    details: "由評審老師針對清唱影片進行線上評分，參賽者只需靜候結果。\n【評分準則】\n1. 歌唱技巧 (40%)：音準、氣息穩定度與共鳴技巧的綜合控制能力。\n2. 發音咬字 (20%)：文字吐息的清晰度與語氣情感的細節處理。\n3. 節奏 (20%)：拍點銜接的準確性與歌曲整體律動的掌握。\n4. 感情 (10%)：對歌曲意境的詮釋深度與聲音的情緒感染力。\n5. 演繹風格 (10%)：舞台肢體、眼神表情與個人形象的整體呈現。"
                },
                {
                    date: "7/8",
                    event: "公告決賽名單",
                ...
                },
                {
                    ...
                    details: (
                        <span>
                            主辦單位安排之專業指導，入圍者需配合出席。若時間無法配合，視為放棄指導機會，不得要求另行安排：{'\n'}
        ...
        qa: {
            ...
            items: [
                ...
                { q: "評分標準是什麼？", a: "由評審老師針對清唱影片進行線上評分，參賽者只需靜候結果。\n【評分準則】\n1. 歌唱技巧 (40%)：音準、氣息穩定度與共鳴技巧的綜合控制能力。\n2. 發音咬字 (20%)：文字吐息的清晰度與語氣情感的細節處理。\n3. 節奏 (20%)：拍點銜接的準確性與歌曲整體律動的掌握。\n4. 感情 (10%)：對歌曲意境的詮釋深度與聲音的情緒感染力。\n5. 演繹風格 (10%)：舞台肢體、眼神表情與個人形象的整體呈現。" },
    ...
    en: {
        ...
        info: {
            ...
            timelineItems: [
                ...
                },
                {
                    ...
                    details: "Professional judges will score the a cappella videos online, and contestants only need to wait for the results.\n[Judging Criteria]\n1. Vocal Technique (40%): Overall control of pitch accuracy, breath stability, and resonance technique.\n2. Pronunciation & Diction (20%): Clarity of articulation and detailed handling of phrasing and emotional nuance.\n3. Rhythm (20%): Accuracy in matching the beat and command of the song's overall groove.\n4. Emotion (10%): Depth of interpretation of the song's mood and the emotional impact of the voice.\n5. Performance Style (10%): The overall presentation of stage movement, eye contact, facial expression, and personal image."
                },
                {
                    date: "Jul 8",
        ...
        qa: {
            ...
            items: [
                ...
                { q: "What are the judging criteria?", a: "Professional judges will score the a cappella videos online, and contestants only need to wait for the results.\n[Judging Criteria]\n1. Vocal Technique (40%): Overall control of pitch accuracy, breath stability, and resonance technique.\n2. Pronunciation & Diction (20%): Clarity of articulation and detailed handling of phrasing and emotional nuance.\n3. Rhythm (20%): Accuracy in matching the beat and command of the song's overall groove.\n4. Emotion (10%): Depth of interpretation of the song's mood and the emotional impact of the voice.\n5. Performance Style (10%): The overall presentation of stage movement, eye contact, facial expression, and personal image." },
    ...
    vi: {
        ...
        info: {
            ...
            timelineItems: [
                ...
                },
                {
                    ...
                    details: "Giám khảo sẽ chấm điểm trực tuyến dựa trên các video hát mộc, và thí sinh chỉ cần chờ kết quả.\n[Tiêu chí Chấm điểm]\n1. Kỹ thuật thanh nhạc (40%): Khả năng kiểm soát tổng thể cao độ, độ ổn định của hơi thở và kỹ thuật cộng hưởng.\n2. Phát âm và nhả chữ (20%): Độ rõ trong cách phát âm và cách xử lý chi tiết về ngữ điệu, sắc thái cảm xúc.\n3. Nhịp điệu (20%): Độ chính xác khi bắt nhịp và khả năng nắm bắt nhịp điệu tổng thể của bài hát.\n4. Cảm xúc (10%): Chiều sâu trong cách diễn giải tinh thần ca khúc và sức truyền cảm của giọng hát.\n5. Phong cách trình diễn (10%): Tổng thể phần thể hiện của chuyển động sân khấu, ánh mắt, biểu cảm và hình ảnh cá nhân."
                },
                {
                    date: "8/7",
        ...
        qa: {
            ...
            items: [
                ...
                { q: "Tiêu chí chấm điểm là gì?", a: "Giám khảo sẽ chấm điểm trực tuyến dựa trên các video hát mộc, và thí sinh chỉ cần chờ kết quả.\n[Tiêu chí Chấm điểm]\n1. Kỹ thuật thanh nhạc (40%): Khả năng kiểm soát tổng thể cao độ, độ ổn định của hơi thở và kỹ thuật cộng hưởng.\n2. Phát âm và nhả chữ (20%): Độ rõ trong cách phát âm và cách xử lý chi tiết về ngữ điệu, sắc thái cảm xúc.\n3. Nhịp điệu (20%): Độ chính xác khi bắt nhịp và khả năng nắm bắt nhịp điệu tổng thể của bài hát.\n4. Cảm xúc (10%): Chiều sâu trong cách diễn giải tinh thần ca khúc và sức truyền cảm của giọng hát.\n5. Phong cách trình diễn (10%): Tổng thể phần thể hiện của chuyển động sân khấu, ánh mắt, biểu cảm và hình ảnh cá nhân." },
