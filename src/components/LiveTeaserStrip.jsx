...
const LiveTeaserStrip = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#1A103C] via-[#3B2875] to-[#1A103C] border-[3px] border-dark shadow-brutal rounded-2xl py-4 md:py-5 px-4 md:px-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2.5">
